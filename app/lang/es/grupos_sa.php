...
//////////////////////// --- Lista de Grupos -----//////////////////////////
    ...
    "lg_subtitulo" => "Aquí encontraras los grupos registrados en su ministerio.",
    ...
    "lg_fil_sin_lider" => "Grupo sin lideres",
    ...
    "ng_msn_parte_1" => "Grupo creado exitosamente",
    "ng_msn_parte_2" => "El nuevo grupo con código",
    ...
    "ag_title" => "Actualizar Grupo", //este es para el título del navegador
    "ag_header" => "ACTUALIZAR GRUPO", //este es para el título de la sección
    "ag_subtitulo" => "Aquí podrás actualizar la información de grupos seleccionado.",


    "ag_msn_parte_1" => "Grupo actualizado exitosamente",

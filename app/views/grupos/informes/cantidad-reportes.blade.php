                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 campo-filtro">
                        <div class="input-group">
                          ...
                          <span class="input-group-btn">
                            ...
                            <a href="/grupos/informe-cantidad-reportes" class="btn btn-danger" ><i class="fa fa-times"></i></a>
                      ...
                      <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 campo-filtro">
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 no-padding" style="padding-right: 5px !important;">
                          <select style="width:100%" id="ordenado-por" name="ordenado-por" class="form-control" data-placeholder="Filtro por línea" >
                            ...
                            <option value="cantidad_reportes" @if(isset($ordenado_por)) @if($ordenado_por=="cantidad_reportes") selected @endif @endif >Ordenado por Cantidad de Reportes</option>
                          </select>
                        </div>
                    ...
                    <table id="tabla-promedios" class="table table-bordered " cellspacing="0" width="100%">
                      <thead style="background: #3C8DBC;color: #FFFFFF;">
                          <tr>
                            ...
                            @endfor
                            <th style="border-left-width: 3px;text-align: center;" align="center">Total<br>Reportes</th>
                          </tr>
                      </thead>
                      <tbody>
                          ...
                          <tr>                                                    
                              ...
                              @for($i=$mes_inicio; $i<=$mes_fin; $i++)
                                @if(strtotime($mes_requerido) <= strtotime(Helper::finalMes(date("Y"), date("m"))))
                                  <td style="vertical-align: middle;" align="center"> {{ $grupo->reportes()->where('fecha','>=', date('Y-m-d', strtotime($mes_requerido)))->where('fecha', '<=', Helper::finalMes(date("Y",strtotime($mes_requerido)), date("m",strtotime($mes_requerido))))->count() }} </td>
                                @else
                              ...
                              @endfor
                             <td style="vertical-align: middle; background: #54AADC;color: #FFFFFF;" align="center"> {{ $grupo->cantidad_reportes }} </td>

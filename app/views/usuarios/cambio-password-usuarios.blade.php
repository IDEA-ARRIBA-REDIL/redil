...
<!-- Vista creada por: Juan Carlos Velasquez 
     ...
     funcion vista: Esta vista le permite al super administrador cambiar la contraseña de cualquier usuario.
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
      ...
      <aside class="right-side">                
        ...
        <section class="content">
          <form action="/usuarios/update-password-user/{{$asistente->id}}" method="post" role=-"form">
            <div class="row">
                ...
                <div class=" box-header">
                  <div class="col-lg-12">
                    ...
                    <div class="desvanecer alert alert-success col-lg-12" style="padding-bottom:5px; padding-top:5px; margin-bottom: -5px" >
                      ...
                      La nueva contraseña de <b> {{$asistente->nombre}} {{$asistente->apellido}}</b> se guardo correctamente. 
                    </div>
                    @endif
              ...
              <div class="col-md-8">
                <div class="box box-primary">
                  <div class="panel-heading">
                    <h3 class="box-title">Cambiar Contraseña <b>{{$asistente->nombre}} {{$asistente->apellido}}</b> </h3>
                  </div>
                    <div class="panel-body">
                      ...
                      <a href="/inicio" class="btn btn-danger"> <i class="fa fa-undo"></i> Cancelar</a>
                    </div> <!-- /box-body -->
                </div>
              </div>
              <!-- /columna de formulario cambio de contraseña  -->
              ...
              <div class="col-lg-4 col-md-6">
                <div class="box">
                  ...
                  <h2><b>Recuerda</b></h2>
                  <p> 
                    La contraseña debe contener como mínimo 5 caracteres, una letra minúscula y un número. 
                  </p>
                  </div>
                </div>
                <div class="box">
                  ...
                  <h2><b>Se enviara</b></h2>
                    <p> 
                     Una vez guarde la nueva contraseña, se le notificara a través de un mensaje al correo del usuario.                 
                    </p>
                  </div>
                </div>
              </div>

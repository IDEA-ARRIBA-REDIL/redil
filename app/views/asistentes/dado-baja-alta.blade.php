...
<html>
  <head>
    ...
    <title>{{Lang::get('asistentes.na_title_pagina')}}| @if($asistente->trashed()){{ Lang::get('asistentes.title_dadoalta')}} @else {{ Lang::get('asistentes.title_dadobaja')}} @endif </title>
            ...
            <div class="col-md-7">
                <div class="box box-primary">
                  <div class="panel-heading">
                    <h3 class="box-title">Deseas dar de @if($asistente->trashed()) alta @else baja @endif  a <b>  {{ $asistente->nombre }} {{ $asistente->apellido }} </b></h3>
                    </div>

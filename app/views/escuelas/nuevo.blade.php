...
<html>
    <head>
        <meta charset="UTF-8">
        <title> Redil |  {{ Lang::get('escuelas.ne_title') }} </title>
    ...
    <body class="skin-black">
                    ...
                    <section class="content-header">
                      <div class="box-header">
                        <h3 class="content-header barra-titulo">
                            {{ Lang::get('escuelas.ne_header') }}
                            <small>{{ Lang::get('escuelas.ne_subtitulo') }} </small>
                        </h3>
                      </div>
                    </section>
                    <!-- /contendio cabezote -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"style="margin-bottom: 10px;">
                                    <div >
                                        ...
                                        ?>
                                        <div class="alert alert-success col-lg-12" style="padding-bottom:5px; padding-top:5px; margin-bottom: -5px" >
                                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                            <b>{{ Lang::get ('escuelas.ne_msn_parte_1') }}</b> {{ Lang::get ('escuelas.ne_msn_parte_2') }}  <b>{{ $id }}</b>  {{ Lang::get ('escuelas.ne_msn_parte_4') }}  <b>{{ $nombre }}</b>
                                        </div>
                                        @endif
                                    </div>
                                </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name= "nombre" type="text" class="form-control" placeholder=" {{ Lang::get('escuelas.ne_ph_nombre')}} "  required/>
                                                </div>
                                            
                                                <div class="form-group">
                                                    <label> {{ Lang::get('escuelas.ne_lb_descripcion') }} </label> 
                                                    <textarea name="descripcion" class="form-control" rows="6" placeholder="{{ Lang::get('escuelas.ne_ph_descripcion') }}"></textarea>
                                                </div>                                         
                                            </div>
                                            ...
                                            <div class="col-lg-6">                            
                                                ...
                                                <div class="nav navbar-nav panel-ppl-busqueda" style="margin-bottom: 30px;">
                                                    ...
                                                    <li class="dropdown messages-menu">
                                                      <div class="input-group "  >
                                                        <input type="text" id="busqueda_director" class="form-control busqueda-fb" autocomplete="off" placeholder="Buscar el director entre los líderes" />
                                                ...
                                                <input id="director_id" name="director_id" type="hidden" class="form-control" value="" placeholder="" />
        ...
        //necesito actualizarlo para que desaparazca o aparezca nuevamente como opcion para vovler a añadir
            ...
            var id_director_seleccionado=""; //esta variable solo es para saber cuales son los directors del grupo y poder mostrar el mensaje se alerta si se intenta seleccionar de nuevo

                  ...
                  <tr>
                    <td valign="top" align="left" style="border-bottom-left-radius:4px;border-bottom-right-radius:4px;background:#ffffff;padding:10px 20px 20px 20px">
                      <div style="margin-bottom:15px">
                        <br><br>
                        <p style="font:15px/1.25em 'Century Gothic',Arial,Helvetica;color:#939393">¡ Hola, <b style="color:#f333">{{$nombre}} {{$apellido}}</b></p>
                        <p style="font:15px/1.25em 'Century Gothic',Arial,Helvetica;color:#939393"> Su contraseña ha sido cambiada satisfactoriamente por parte del administrador, su nueva contraseña es:</p>
                        <br>
                        <p  class="centrar-text" style="font:15px/1.25em 'Century Gothic',Arial,Helvetica;color:#939393"><b>{{$contra}}</b></p>
